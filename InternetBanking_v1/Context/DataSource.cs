...
namespace InternetBanking_v1.Context
{
    public class DataSource
    {
        ...
        public String getaccount(string user_id)
        {
            ...
            {
                string query = " SELECT acc_id,ADDITIONAL_REFERENCE from user_acc_link where user_id =" + user_id;
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["ADDITIONAL_REFERENCE"] != DBNull.Value)
                            {
                                Accounts = Accounts + "-" + (string)dataReader["ADDITIONAL_REFERENCE"];
        ...
        public List<AccountStatementViewModel> getAccountsArray(string user_id)
        {
            List<AccountStatementViewModel> Accounts = new List<AccountStatementViewModel>();
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = "select acc_id,ADDITIONAL_REFERENCE,branch_name,act_name,curr_name  from user_acc_link ua, branchs b,act_types a,currency c where user_id = '"+user_id+"' and ua.act_type=a.act_type_code and ua.branch_code=b.branch_code and ua.acc_curr=c.curr_code";
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            if (dataReader["ADDITIONAL_REFERENCE"] != DBNull.Value)
                            {
                                //Accounts.Add((string)dataReader["ADDITIONAL_REFERENCE"]);
                                Accounts.Add(new AccountStatementViewModel
                                {
                                    AdditionalRefrence = (string)dataReader["ADDITIONAL_REFERENCE"],
                                    BranchCode = (string)dataReader["branch_name"],
                                    AccountType = (string)dataReader["act_name"],
                                    AccountCurrency = (string)dataReader["curr_name"]
                                });
                            }
                        }
                    }
        ...
        public String getActTypes(string user_id)
        {
            String Accounts = "";
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = " SELECT acc_id,act_type from user_acc_link where user_id =" + user_id;
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["act_type"] != DBNull.Value)
                            {
                                Accounts = Accounts + "-" + (string)dataReader["act_type"];
                            }
        ...
        public String getcurrencies(string user_id)
        {
            String currencies = "";
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = " SELECT acc_id,acc_curr from user_acc_link where user_id =" + user_id;
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["acc_curr"] != DBNull.Value)
                            {
                                currencies = currencies + "-" + (string)dataReader["acc_curr"];
                                //Accounts = Accounts.Substring(2);
                            }
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["ADDITIONAL_REFERENCE"] != DBNull.Value)
                            {
                                Accounts = (string)dataReader["ADDITIONAL_REFERENCE"];
                                //Accounts = Accounts.Substring(2);
                            }
        ...
        public List<AccountStatementViewModel> DropStatementClient(string user_id)
        {
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = " SELECT acc_id,acc_no,ADDITIONAL_REFERENCE,act_type from user_acc_link where user_id =" + user_id;
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if(dataReader["ADDITIONAL_REFERENCE"] != DBNull.Value)
                            {
                                obj.Additional_Reference = (string)dataReader["ADDITIONAL_REFERENCE"];
                            }
                            if (dataReader["act_type"] != DBNull.Value)
                            {
                                obj.AccountType = (string)dataReader["act_type"];
                            }
                            list.Add(obj);
                        }
                    }
        ...
        public List<AccountStatementViewModel> getCurrentAccounts(string user_id)
        {
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = "SELECT acc_id,acc_no from user_acc_link where substr(acc_no,6,5) in ('11101','11106') and user_id = " + user_id;
        ...
        public List<CardTransferViewModel> DropCardClient(string user_id)
        {
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = "SELECT card_name,card_number ,card_exp from user_card_link where user_id =" + user_id;
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["card_name"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["card_exp"] != DBNull.Value)
                            {
                                obj.CardExp = (string)dataReader["card_exp"];
                            }
                            list.Add(obj);
                        }
                    }
        ...
        public List<NonCustomerTransferViewModel> NonCustomerTransferAccount(string user_id)
        {
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = " SELECT acc_id,acc_no from user_acc_link where ACC_CURR='938' or ACC_CURR='840' and user_id =" + user_id;
        ...
        public List<OwnTransferViewModel> DropFromOwnTransferClient(string user_id)
        {
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = " SELECT acc_id,acc_no,ADDITIONAL_REFERENCE,acc_curr from user_acc_link where  ACC_CURR='938' or ACC_CURR='840' and  user_id =" + user_id;
                    ...
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["acc_no"] != DBNull.Value)
                            {
                                ...
                                obj.Additional_Reference = (string)dataReader["ADDITIONAL_REFERENCE"];
                                obj.fromCurrencyCode = (string)dataReader["acc_curr"];
                                obj.toCurrencyCode = (string)dataReader["acc_curr"];
                            }
                            list.Add(obj);
                        }
                    }
        ...
        //-----------------------------------DropClient for SDGAccountTransfer---------------------
        public List<OwnTransferViewModel> DropFromOwnTransferClientSdgOnly(string user_id)
        {
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = " SELECT acc_id,acc_no,ADDITIONAL_REFERENCE,acc_curr,act_type from user_acc_link where  ACC_CURR='938' and  user_id =" + user_id;
                    ...
                    while (dataReader.Read())
                    {
                        ...
                        if (dataReader["acc_id"] != DBNull.Value)
                        {
                            ...
                            if (dataReader["acc_no"] != DBNull.Value)
                            {
                                ...
                                obj.fromCurrencyCode = (string)dataReader["acc_curr"];
                                obj.toCurrencyCode = (string)dataReader["acc_curr"];
                                obj.fromAccountType = (string)dataReader["act_type"];
                            }
                            list.Add(obj);
                        }
                    }
        ...
        //-----------------------  get customer phone number from username  ----------------------------------------------
        ...
        public string getuserphone(string username)
        {
            ...
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = "select user_mobile from users where user_log = '" + username + "'";
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        if (dataReader["user_mobile"] != DBNull.Value)
                        {
                            phonenumber = (string)dataReader["user_mobile"];
                        }
                    }
                    return phonenumber;
                }
        ...
        public decimal getuserid(string username)
        {
            decimal userid = 00;
            using (OracleConnection con = new OracleConnection(conString))
            {
                string query = "select user_id from users where user_log = '" + username + "'";
                ...
                using (IDataReader dataReader = cmd.ExecuteReader())
                {
                    while (dataReader.Read())
                    {
                        ...
                        {
                            userid = (decimal)dataReader["user_id"];
                        }
                    }
                    return userid;
                }
