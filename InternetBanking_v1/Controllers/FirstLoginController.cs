        ...
        public ActionResult ResetPassword(FirstLoginViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (res == 1)
                {
                    ...
                    ViewBag.ResponseStat = GlobalRes.Successful;
                    ViewBag.ResponseMSG = GlobalRes.updatedpasswordsuccedd; //"Your Password has been updated successfully";
                ...
                else
                {
                    TempData["Success"] = true;
                    //ModelState.AddModelError("", tranRes.ToString());
                    ViewBag.ResponseStat = GlobalRes.NotSuccessful;
