        ...
        public ActionResult ToBankCustomerTransfer()
        {
            ...
            foreach (var item in pcontent)
            {
                ...
                AccountList.Add(new SelectListItem
                {
                    ...
                    Value = item.FromAccount.ToString() + "-" + item.fromCurrencyCode
                });
            }
                ...
                if (vCode.Equals(OTPPassword))
                {
                    ...
                    try
                    {
                        ...
                        if (errorCode != null && !errorCode.ToString().Equals("0"))
                        {
                            ...
                            data.InsertTransferToTranLog(user_id, "To Bank Customer Transfer Corprate", req, res, errormsg.ToString(),
                        ...
                        else
                        {
                            ...
                            //insert into TranLog
                            string req = model.FromAccount + "," + model.CustomerAccount + "," + model.Amount;
                            data.InsertTranLog(user_id, "To Bank Customer Transfer Corprate", req, res, errormsg.ToString(), tranRes.ToString(), model.Amount, "Timed Out");
                            data.InsertTransferToTranLog(user_id, "To Bank Customer Transfer Corprate", req, res, errormsg.ToString(),
                                tranRes.ToString(), model.Amount, responseStatus, senderName.ToString(), recieverName.ToString());
                    ...
                    catch (Exception e)
                    {
                        ...
                        data.InsertTranLog(user_id, "To Bank Customer Transfer Corprate", req, "", "failed", "", model.Amount, "Timed Out");
                    }
